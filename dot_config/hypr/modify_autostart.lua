#!/bin/bash
# Maintain a personal Hyprland autostart block idempotently. Strips any
# previously-applied block between markers, trims trailing blank lines, then
# re-appends the canonical block.
set -e
